...
export const metadata = {
  title: "Write for Us — The Trip Tales",
  description: "How to write for The Trip Tales: what makes a good tale, what happens after you submit, and who keeps the rights (you do).",
};
