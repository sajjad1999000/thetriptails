...
import LocalsNotesLibraryHeader from '@/components/admin/LocalsNotesLibraryHeader';
...
export default async function LocalsNotesLibraryPage({ searchParams }) {
  ...
  return (
    <LocalsNotesLibraryHeader activeStatus={activeStatus} counts={counts} error={!!error}>
      <StoriesLibraryTable stories={stories ?? []} basePath="/admin/locals-notes/library" activeStatus={activeStatus} />
    </LocalsNotesLibraryHeader>
  );
}