...
export default function LocalsNotesHeader({
  activeStatus,
  counts,
  error,
  children,
  ...
  return (
    <div className="submissions-page">
      <h1 className="submissions-title">Locals&apos; Notes</h1>

      <div className="submissions-tabs">
        {TABS.map((tab) => (
          <Link
            key={tab.key}
            href={`/admin/locals-notes?status=${tab.key}`}
      ...
      {error && (
        <p className="submissions-error">
          Couldn&apos;t load locals&apos; notes right now. Try refreshing.
        </p>
      )}
