// components/admin/LocalsNotesTable.jsx
// Same structure as SubmissionsTable.jsx, but row links point at
// /admin/locals-notes/[id] instead of /admin/submissions/[id].
...
export default function LocalsNotesTable({ submissions, activeStatus }) {
    ...
    return (
      <div className="submissions-empty">
        <p>
          {activeStatus === 'all'
            ? "No locals' notes yet."
            : `No ${activeStatus} locals' notes right now.`}
        </p>
            ...
            return (
              <tr key={submission.id}>
                <td data-label="Title / Name">
                  <Link href={`/admin/locals-notes/${submission.id}`} className="submissions-row-link">
