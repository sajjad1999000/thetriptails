...
export const metadata = {
  title: "Advertise — The Trip Tales",
  description: "Story-led partnerships with The Trip Tales — no banner ads, no pop-ups, just true tales that mention your destination or brand honestly.",
};
    ...
    <section className={styles.advertise}>
      <div className="inner" style={{ maxWidth: "740px" }}>
        ...
        <div className={styles.block}>
          ...
          <p className={`rv ${styles.p}`}>
            The Trip Tales is early — I&apos;m not going to hand you
