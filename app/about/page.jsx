...
export const metadata = {
  title: "About | The Trip Tales",
  description:
    "The Trip Tales is built by one traveller who believes every trip leaves a tale worth telling. Here's why it exists.",
};
    ...
    <>
      <section className={styles.about}>
        <div className={`inner ${styles.grid}`}>
          ...
          <div>
            <Kicker className="rv">Behind The Trip Tales</Kicker>
            ...
            <p className={`rv ${styles.p}`}>
              The Trip Tales exists so that stops happening. The internet
