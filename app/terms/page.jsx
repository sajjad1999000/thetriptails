...
export const metadata = {
  title: "Terms of Service — The Trip Tales",
  description: "The terms that govern use of The Trip Tales.",
};
    ...
    <main>
      ...
      <section className={styles.body}>
        <article className={`inner ${styles.article}`}>
          ...
          <p>
            By using The Trip Tales ("the site"), you agree to these terms. If you don't agree,
            please don't use the site.
          </p>

          <h2>1. What The Trip Tales is</h2>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              edit, publish, and display it on The Trip Tales with your byline. You can request
              removal at any time.
            </li>
          ...
          <p>
            ...
            Tales. Contributor stories remain owned by their authors under the license described
          ...
          <p>
            ...
            information. To the fullest extent permitted by law, The Trip Tales isn't liable for
