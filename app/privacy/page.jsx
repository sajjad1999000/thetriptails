...
export const metadata = {
  title: "Privacy Policy — The Trip Tales",
  description: "How The Trip Tales collects, uses, and protects your information.",
};
    ...
    <main>
      ...
      <section className={styles.body}>
        <article className={`inner ${styles.article}`}>
          <p>
            The Trip Tales ("we," "us," "our") publishes true, first-person travel stories from
          ...
          <p>
            The Trip Tales is not directed at children under 16, and we don't knowingly collect
