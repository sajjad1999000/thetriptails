// app/admin/(protected)/locals-notes/library/[id]/page.jsx
// Edit an existing Locals' Note directly by story id — mirrors
// stories/[id]/page.jsx exactly, fixedStoryType="locals_note".
...
export default async function EditLocalsNotePage({ params }) {
    ...
    <div>
      <header style={{ padding: '1.5rem 6vw 0' }}>
        <p style={{ fontFamily: 'var(--body)', color: 'var(--ink)', fontSize: '0.95rem', margin: '0 0 1rem' }}>
          Editing note: <strong>{story.title}</strong> · Status: <strong>{story.status}</strong>
        </p>
