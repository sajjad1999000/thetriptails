...
export const metadata = {
  title: "Disclaimer — The Trip Tales",
  description: "Important context on how to read the content published on The Trip Tales.",
};
    ...
    <main>
      ...
      <section className={styles.body}>
        <article className={`inner ${styles.article}`}>
          ...
          <p>
            Stories on The Trip Tales describe one traveller's real experience. They aren't
          ...
          <p>
            ...
            who posted them, not the views of The Trip Tales. We moderate for our community
